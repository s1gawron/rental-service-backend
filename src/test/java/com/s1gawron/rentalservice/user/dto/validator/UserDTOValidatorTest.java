...
class UserDTOValidatorTest {
    ...
    void shouldValidate() {
        ...
        final UserRegisterRequest userRegisterRequest = new UserRegisterRequest("test@test.pl", "Start00!", "John", "Kowalski", "CUSTOMER", addressDTO);
    ...
    void shouldThrowExceptionWhenEmailIsNull() {
        final AddressDTO addressDTO = new AddressDTO("Poland", "Warsaw", "Test", "01-000");
        final UserRegisterRequest userRegisterRequest = new UserRegisterRequest(null, "Start00!", "John", "Kowalski", "CUSTOMER", addressDTO);
    ...
    void shouldThrowExceptionWhenPasswordIsNull() {
        final AddressDTO addressDTO = new AddressDTO("Poland", "Warsaw", "Test", "01-000");
        final UserRegisterRequest userRegisterRequest = new UserRegisterRequest("test@test.pl", null, "John", "Kowalski", "CUSTOMER", addressDTO);
    ...
    void shouldThrowExceptionWhenFirstNameIsNull() {
        final AddressDTO addressDTO = new AddressDTO("Poland", "Warsaw", "Test", "01-000");
        final UserRegisterRequest userRegisterRequest = new UserRegisterRequest("test@test.pl", "Start00!", null, "Kowalski", "CUSTOMER", addressDTO);
    ...
    void shouldThrowExceptionWhenLastNameIsNull() {
        final AddressDTO addressDTO = new AddressDTO("Poland", "Warsaw", "Test", "01-000");
        final UserRegisterRequest userRegisterRequest = new UserRegisterRequest("test@test.pl", "Start00!", "John", null, "CUSTOMER", addressDTO);
    ...
    void shouldThrowExceptionWhenUserRoleDoesNotExist() {
        final AddressDTO addressDTO = new AddressDTO("Poland", "Warsaw", "Test", "01-000");
        final UserRegisterRequest userRegisterRequest = new UserRegisterRequest("test@test.pl", "Start00!", "John", "Kowalski", "Unknown", addressDTO);

        assertThrows(UserRoleDoesNotExistException.class, () -> UserDTOValidator.I.validate(userRegisterRequest), "Role: UNKNOWN does not exist!");
    }
    ...
    void shouldThrowExceptionWhenPasswordIsTooWeak() {
        final AddressDTO addressDTO = new AddressDTO("Poland", "Warsaw", "Test", "01-000");
        final UserRegisterRequest userRegisterRequest = new UserRegisterRequest("test@test.pl", "password", "John", "Kowalski", "CUSTOMER", addressDTO);
